...
public:
    ...
    */
    ...
    /**
    * @brief create device buffer of pic
    * @param [in] picData: pic data
    * @param [in] picDesc: pic desc
    * @param [out] picDevBuffer: device memory of picture
    * @param [out] devPicBufferSize: size of pic
    * @return device buffer of pic
    */
    static Result GetDeviceBufferOfPictureMemery(std::vector<u_int8_t> &picData, PicDesc &picDesc, void *&picDevBuffer, uint32_t &devPicBufferSize);


    /**
    * @brief create buffer of memery
    * @param [in] picDesc: picture description
    * @param [out] inputBuff: input data buffer
    * @param [out] fileSize: size of file
    * @return result
    */
    static Result ReadBinMemery(std::vector<u_int8_t> &picData, PicDesc &picDesc, void *&inputBuff, uint32_t &memerySize);
