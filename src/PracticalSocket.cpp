...
SocketException::SocketException(const std::string &message, bool inclSysMsg)
  noexcept(true) : userMessage(message) {
  if (inclSysMsg) {
    userMessage.append(": ");
...
const char *SocketException::what() const noexcept(true) {
...
void UDPSocket::joinGroup(const std::string &multicastGroup) noexcept(false) {
...
void UDPSocket::leaveGroup(const std::string &multicastGroup) noexcept(false) {
  struct ip_mreq multicastRequest;
